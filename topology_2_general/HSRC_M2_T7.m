...
ncc = 14; % see page 13 of SPCOM journal version draft
...
% var_D = 23; D_mat = [931, 954, 977, 1000, 1023, 1046, 1069];
% var_q = 0.014560; q_mat = [0.256321, 0.270881, 0.285440, 0.300000, 0.314560, 0.329119, 0.343679];
var_D = 88; D_mat = [736, 824, 912, 1000, 1088, 1176, 1264];
var_q = 0.031703; q_mat = [0.204892, 0.236595, 0.268297, 0.300000, 0.331703, 0.363405, 0.395108];
...
%                 temp(h,b,m) = temp(h,b,m) + active_inrange(b,i2)*random('bino',1,2^(-I(b,m)/l));
        ...
        for ind=1:l
            if (temp(ind,3,m)>=2 || temp(ind,6,m)>=2 || (temp(ind,3,m)==1 && temp(ind,6,m)==1))
                    R5 =R5 + 1;
            else %If the above condition is true, 3C always occurs.

                if ((temp(ind,3,m)==1 && temp(ind,6,m)==0) || (temp(ind,3,m)==0 && temp(ind,6,m)==1))
                    if((temp(ind,1,m) + temp(ind,2,m) + temp(ind,7,m))>=1 && (temp(ind,4,m) + temp(ind,5,m) + temp(ind,7,m))>=1 && (temp(ind,2,m) + temp(ind,5,m))>=1)
                        R5 =R5 + 1;
                    end
                    
                elseif (temp(ind,3,m)==0 && temp(ind,6,m)==0)
                    if((temp(ind,1,m) + temp(ind,2,m) + temp(ind,7,m))>=2 && (temp(ind,4,m) + temp(ind,5,m) + temp(ind,7,m))>=2 && (temp(ind,2,m) + temp(ind,5,m))>=2)
                        R5 =R5 + 1;
                    end
                end
                switch 1
                    % 1C cases below
                    case ((temp(ind,1,m)>=2) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==1) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (C,beta,beta) case
                        R1=R1+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==1) && (temp(ind,7,m)==0)) % (C,beta,beta) case
                        R1=R1+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=2) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (alpha,alpha,C) case
                        R1=R1+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==1) && (temp(ind,4,m)>=1) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (alpha,alpha,C) case
                        R1=R1+1;
                    % some cases of 1C that are different in T=7
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=1) && (temp(ind,5,m)==0) && (temp(ind,6,m)==1) && (temp(ind,7,m)==0)) % (beta,beta,C) case, {4,6}
                        R1=R1+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)==1) && (temp(ind,6,m)==0) && (temp(ind,7,m)==1)) % (beta,beta,C) case, {4,{5,7}}
                        R1=R1+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==0) && (temp(ind,3,m)==1) && (temp(ind,4,m)==0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (C,alpha,alpha) case, {1,3}
                        R1=R1+1;
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==1)) % (C,alpha,alpha) case, {1, {2,7}}
                        R1=R1+1;
                    % not sure about node 1
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)>=2) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (C,C,E) case
                        R1=R1+1;
                    %not sure about 1, one of {3,7}
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)>=1) && (temp(ind,3,m)==1) && (temp(ind,4,m)==0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (C,C,alpha) case
                        R2=R2+1; % this is correct
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)>=2) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==1)) % (C,C,alpha) case
                        R2=R2+1; % this is correct
                    % not sure about 1, one of {4,5,6}
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)>=2) && (temp(ind,3,m)==0) && (temp(ind,4,m)==1) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (C,C,beta) case
                        R2=R2+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==1) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (C,C,beta) case
                        R2=R2+1;
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)>=2) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==1) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (C,C,beta) case
                        R2=R2+1;
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)>=1) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==1) && (temp(ind,7,m)==0)) % (C,C,beta) case
                        R2=R2+1;
                    % not sure about node 4
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)>=2) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (E,C,C) case
                        R1=R1+1;
                    % not sure about 4, one of {1,2,3}
                    case ((temp(ind,1,m)==1) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)>=2) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (alpha,C,C) case
                        R2=R2+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=1) && (temp(ind,5,m)>=1) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (alpha,C,C) case
                        R2=R2+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)>=2) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (alpha,C,C) case
                        R2=R2+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==1) && (temp(ind,4,m)>=0) && (temp(ind,5,m)>=1) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (alpha,C,C) case
                        R2=R2+1;
                    % not sure about 4, one of {6,7}
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)>=1) && (temp(ind,6,m)==1) && (temp(ind,7,m)==0)) % (beta,C,C) case
                        R2=R2+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)>=2) && (temp(ind,6,m)==0) && (temp(ind,7,m)==1)) % (beta,C,C) case
                        R2=R2+1;
                    % not sure about 1,4,7
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)>=2)) % (beta,C,C) case
                        R3=R3+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=1) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==1)) % (beta,C,C) case
                        R3=R3+1;
                    case ((temp(ind,1,m)>=2) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=2) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (beta,C,C) case
                        R3=R3+1;
                    % not sure about not sure about 1,4,7, one of {2,3}
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)>=2)) % (C,alpha,C) case
                        R4=R4+1;
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=1) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==1)) % (C,alpha,C) case
                        R4=R4+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=2) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (C,alpha,C) case
                        R4=R4+1;
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==1) && (temp(ind,4,m)>=0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)>=1)) % (C,alpha,C) case
                        R4=R4+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==0) && (temp(ind,3,m)==1) && (temp(ind,4,m)>=1) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (C,alpha,C) case
                        R4=R4+1;
                    % not sure about not sure about 1,4,7, one of {5,6}
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)==1) && (temp(ind,6,m)==0) && (temp(ind,7,m)>=2)) % (C,beta,C) case
                        R4=R4+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)==1) && (temp(ind,6,m)==0) && (temp(ind,7,m)==1)) % (C,beta,C) case
                        R4=R4+1;
                    case ((temp(ind,1,m)>=2) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=1) && (temp(ind,5,m)==1) && (temp(ind,6,m)==0) && (temp(ind,7,m)==0)) % (C,beta,C) case
                        R4=R4+1;
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==1) && (temp(ind,7,m)>=1)) % (C,beta,C) case
                        R4=R4+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=1) && (temp(ind,5,m)==0) && (temp(ind,6,m)==1) && (temp(ind,7,m)==0)) % (C,beta,C) case
                        R4=R4+1;
                end
            end
...
%         Prop_Method(m) = Prop_Method(m) + (3)*l+ (len*l)/b + R1 + 2*R2 + 3*R3 + 4*R4 + R5*((M2T3/l) + (M2T4/l)); % with BP lenght
        Prop_Method(m) = Prop_Method(m) + (3)*l+ 1 + R1 + 2*R2 + 3*R3 + 4*R4 + R5*((M2T3/l) + (M2T4/l)); % without BP lenght        
%         Prop_Method(m) = Prop_Method(m) + (3)*l+ 1 + R1 + 2*R2 + 3*R3 + 4*R4 + R5*((M2T3_vs_q(q_ind)/l) + (M2T4_vs_q(q_ind)/l));
    end % end loop for m
...
save M2T7.txt avg_slots -ascii %To save the values, which can be used in 4dev, 6dev etc.
% save M2T7_vs_D.txt Prop_Method_D -ascii
% save M2T7_vs_eps.txt Prop_Method_eps -ascii
% save M2T7_vs_q.txt Prop_Method_q -ascii