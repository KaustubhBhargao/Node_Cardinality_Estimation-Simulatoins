...
D_mean = 1000;
q_mean = 0.3; % actual q_mean = 0.3
% var_D = 59; D_mat = [823, 882, 941, 1059, 1118, 1177];
% var_q = 0.046710; q_mat = [0.159870, 0.206580, 0.253290, 0.346710, 0.393420, 0.440130];
var_D = 154; D_mat = [538, 692, 846, 1154, 1308, 1462];
var_q = 0.053231; q_mat = [0.140307, 0.193538, 0.246769, 0.353231, 0.406462, 0.459693];
        ...
        for ind=1:l
            if (temp(ind,3,m)>=2 || temp(ind,6,m)>=2 || (temp(ind,3,m)==1 && temp(ind,6,m)==1))
                ...
                if ((temp(ind,3,m)==1 && temp(ind,6,m)==0) || (temp(ind,3,m)==0 && temp(ind,6,m)==1))
                    if( (temp(ind,1,m) + temp(ind,2,m))>=1 && (temp(ind,4,m) + temp(ind,5,m))>=1 && (temp(ind,2,m) + temp(ind,5,m))>=1)
                        R3 =R3 + 1;
                    end
                    
                elseif (temp(ind,3,m)==0 && temp(ind,6,m)==0)
                    if((temp(ind,1,m) + temp(ind,2,m))>=2 && (temp(ind,4,m) + temp(ind,5,m))>=2 && (temp(ind,2,m) + temp(ind,5,m)>=2))
                        R3 =R3 + 1;
                    end
                end
                switch 1
                    % 1C cases below
                    case ((temp(ind,1,m)>=2) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==1) && (temp(ind,6,m)==0)) % (C,beta,beta) case
                        R1=R1+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==1)) % (C,beta,beta) case
                        R1=R1+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=2) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0)) % (alpha,alpha,C) case
                        R1=R1+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==1) && (temp(ind,4,m)>=1) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0)) % (alpha,alpha,C) case
                        R1=R1+1;
    
                    % 2C cases below
                    % not sure about node 1
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)>=2) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0)) % (C,C,E) case
                        R1=R1+1;
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)>=1) && (temp(ind,3,m)==1) && (temp(ind,4,m)==0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0)) % (C,C,alpha) case
                        R1=R1+1;
                    % not sure about node 4
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)>=2) && (temp(ind,6,m)==0)) % (E,C,C) case
                        R1=R1+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)>=1) && (temp(ind,6,m)==1)) % (beta,C,C) case
                        R1=R1+1;
                    % not sure about two nodes
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=2) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0)) % (C,alpha,C) case
                        R1=R1+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==0) && (temp(ind,3,m)==1) && (temp(ind,4,m)>=1) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0)) % (C,alpha,C) case
                        R1=R1+1;
                    case ((temp(ind,1,m)>=2) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=1) && (temp(ind,5,m)==1) && (temp(ind,6,m)==0)) % (C,beta,C) case
                        R1=R1+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=1) && (temp(ind,5,m)==0) && (temp(ind,6,m)==1)) % (C,beta,C) case
                        R1=R1+1;
                    %special cases for 2C
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)>=2) && (temp(ind,3,m)==0) && (temp(ind,4,m)==1) && (temp(ind,5,m)==0) && (temp(ind,6,m)==0)) % (C,C,beta) case
                        R2=R2+1;
                    case ((temp(ind,1,m)>=1) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==1) && (temp(ind,6,m)==0)) % (C,C,beta) case
                        R2=R2+1;
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)>=2) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==1) && (temp(ind,6,m)==0)) % (C,C,beta) case
                        R2=R2+1;
                    case ((temp(ind,1,m)>=0) && (temp(ind,2,m)>=1) && (temp(ind,3,m)==0) && (temp(ind,4,m)==0) && (temp(ind,5,m)==0) && (temp(ind,6,m)==1)) % (C,C,beta) case
                        R2=R2+1;
                    case ((temp(ind,1,m)==1) && (temp(ind,2,m)==0) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)>=2) && (temp(ind,6,m)==0)) % (alpha,C,C) case
                        R2=R2+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=1) && (temp(ind,5,m)>=1) && (temp(ind,6,m)==0)) % (alpha,C,C) case
                        R2=R2+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==1) && (temp(ind,3,m)==0) && (temp(ind,4,m)>=0) && (temp(ind,5,m)>=2) && (temp(ind,6,m)==0)) % (alpha,C,C) case
                        R2=R2+1;
                    case ((temp(ind,1,m)==0) && (temp(ind,2,m)==0) && (temp(ind,3,m)==1) && (temp(ind,4,m)>=0) && (temp(ind,5,m)>=1) && (temp(ind,6,m)==0)) % (alpha,C,C) case
                        R2=R2+1;
                end
            end
...
%         Prop_Method(m) = Prop_Method(m) + (3)*l+ (len*l)/b + R1 + 2*R2 + R3*((M2T3/l)); % with BP lenght
        Prop_Method(m) = Prop_Method(m) + (3)*l+ 1 + R1 + 2*R2 + R3*(2*(M2T3/l)); % without BP lenght   
%         Prop_Method(m) = Prop_Method(m) + (3)*l+ 1 + R1 + 2*R2 + R3*(2*(M2T3_vs_q(q_ind)/l));
    end % end loop for m
...
save M2T6.txt avg_slots -ascii %To save the values, which can be used in 4dev, 6dev etc.
% save M2T6_vs_D.txt Prop_Method_D -ascii 
% save M2T6_vs_eps.txt Prop_Method_eps -ascii
% save M2T6_vs_q.txt Prop_Method_q -ascii