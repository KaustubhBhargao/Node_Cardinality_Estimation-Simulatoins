...
% p = 'test';
% p.Style = {Bold(true)};
plot(T_xpoints, C2_M1_vs_T,':.k', T_xpoints, C2_M2_vs_T,'--diamondk', T_xpoints, C2_Trep_vs_T,':*k');%,x,u,':.k');
set(gca,'FontSize',16,'FontName','Times New Roman');
title('\textbf{Number of slots $\overline{T}$}','FontName','Times New Roman', 'FontWeight','bold', 'FontSize', 16, 'interpreter','latex');
% title('Number of slots $$\overline{T}$$','FontName','Times New Roman', 'FontWeight','bold', 'FontSize', 16);
