...
% p = 'test';
% p.Style = {Bold(true)};
plot(q_xpoints, C2_M1_vs_q_T5,':.k', q_xpoints, C2_M2_vs_q_T5,'--diamondk', q_xpoints, C2_Trep_vs_q_T5,':*k');%,x,u,':.k');
set(gca,'FontSize',16,'FontName','Times New Roman');
title('\textbf{Number of slots required vs $\overline{q}$}','FontName','Times New Roman', 'FontWeight','bold', 'FontSize', 16, 'interpreter','latex');
% title('Number of slots vs $\overbar{D}$','FontName','Times New Roman', 'FontWeight','bold', 'FontSize', 16);
xlabel('$\overline{q}$','FontSize',16, 'interpreter', 'latex');
