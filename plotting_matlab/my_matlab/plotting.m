...
% p = 'test';
% p.Style = {Bold(true)};
plot(R_xpoints, C4_M1_vs_R_T5,':.k', R_xpoints, C4_M2_vs_R_T5,'--diamondk', R_xpoints, C4_Trep_vs_R_T5,':*k');%,x,u,':.k');
set(gca,'FontSize',16,'FontName','Times New Roman');
% title(p, 'FontWeight','bold')
% uicontrol( 'style', 'text', 'string', 'abcd1234', 'fontweight', 'bold');
% title('test', 'FontWeight', 'bold','FontSize', 14);
title('Number of slots required vs D','FontName','Times New Roman', 'FontWeight','bold', 'FontSize', 14);
xlabel('Range (R)','FontSize',16);
...
legend(Legend,'FontSize',14, 'Location', 'northeast')
